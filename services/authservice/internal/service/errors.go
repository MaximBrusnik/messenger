...
func errUnauthenticated(msg string) error  { return apperr.New(codes.Unauthenticated, msg) }
func errFailedPrecondition(msg string) error {
	return apperr.New(codes.FailedPrecondition, msg)
}
func errUnavailable(msg string) error { return apperr.New(codes.Unavailable, msg) }
